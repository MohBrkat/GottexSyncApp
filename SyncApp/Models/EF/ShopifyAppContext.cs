...
{
    public partial class ShopifyAppContext : DbContext
    {
        public ShopifyAppContext()
        {
        }

        public ShopifyAppContext(DbContextOptions<ShopifyAppContext> options)
            : base(options)
        {
        }

        public virtual DbSet<AggregatedCounter> AggregatedCounter { get; set; }
        public virtual DbSet<Configrations> Configrations { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Configrations>(entity =>
            {
                entity.Property(e => e.BranchCodeReceipt).HasMaxLength(50);

                entity.Property(e => e.BranchcodeSalesInvoices).HasMaxLength(50);

                entity.Property(e => e.CustoemrCode).HasMaxLength(50);

                entity.Property(e => e.FtpHost).HasMaxLength(50);
            ...
            modelBuilder.Entity<PaymentMeans>(entity =>
            {
