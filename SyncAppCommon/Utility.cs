...
namespace SyncAppCommon
{
    public class Utility
    {
        ...
        public static void SendEmail(string smtpHost, int smtpPort, string emailUserName, string emailPassword, string displayName, string reportEmailAddress1, string reportEmailAddress2, string body, string subject)
        {
            try
            {
    ...
    public class FtpHandler
    {
        ...
        public static bool CheckIfFileExistsOnServer(string host, string userName, string password, string folderPath, string fileName)
        {
            string url = host + "/" + folderPath + "/";
